...
# Usage:
#   send-file-tg.sh --document /data/repo/inbox/files/x.pdf
#   send-file-tg.sh --photo    /data/repo/inbox/files/sunset.jpg --caption "Sunset"
#   send-file-tg.sh --document /data/repo/notes/x.md --caption "Notes" --parse-mode MarkdownV2
#
